...
I've decided to start working on BigMac 3. The plan is to turn it into a menu bar app and have it designed in the order operations show proceed. This will be an entire overall. It will have some nice features like a GUI for sudo that will work with admin/password, touch id, apple watch and even a yubikey!  
