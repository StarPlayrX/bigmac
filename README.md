...
<b>BMO One</b> For users who cannot install, there's BMO1 for testing purposes. https://starplayrx.com/downloads/bigmac/BMO1.dmg Format a disk using MacOS Extended Journal and copy and paste this in the Terminal `sudo asr -s ~/Downloads/BMO1.dmg -er -nov -t /Volumes/changeMe` Run the bigmac's `sudo postinstall.sh` to this disk. 
