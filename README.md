...
We have decied that BigMac will not be including the OCLP application. We will give credit to OCLP as portions from our setup use OCLP as a starting point, but future versions of BM will use it's own OC customization process.
