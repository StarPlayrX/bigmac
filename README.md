...
<b>BMO One</b>Can't get bigmac to work? There's the <a href="https://starplayrx.com/downloads/bigmac/BMO1.dmg>BMO1.dmg</a> After it downloads. Format a disk using MacOS Extended Journal and copy and paste this in the Terminal `sudo -s ~/Downloads/BMO1.dmg -er -nov -t /Volumes/changeMe`
