...
11. Because the preinstall script run memory, do not attempt run the preinstall twice in the same session. This will cause major delays when opening the Big Sur install app/task.
