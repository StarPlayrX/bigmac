...
<b>BMO One</b> Can't get bigmac to work? There's the BMO1 Download, squeaky clean install https://starplayrx.com/downloads/bigmac/BMO1.dmg After it downloads, format a disk using MacOS Extended Journal and copy and paste this in the Terminal `sudo -s ~/Downloads/BMO1.dmg -er -nov -t /Volumes/changeMe` Then run the bigmac's post install on the disk. This is for experimental / for testing purposes only.
